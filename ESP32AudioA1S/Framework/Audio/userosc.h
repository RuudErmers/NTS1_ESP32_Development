...
#ifdef MAIN
void fwSetup();void setup(){  fwSetup();}
void fwLoop(); void loop() {  fwLoop(); }
#endif
...
#define f32_to_q31(f)   ((q31_t)((float)(f) * (float)0x7FFFFFF0))
...
extern void OSC_DoNoteEvent(uint8_t pitch, uint8_t velocity);
#endif