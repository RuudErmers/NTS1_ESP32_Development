...
public:
  ...
  void ReadSampleSync(TSample &LeftAndRight)  { while (FSize==0) delay(1); ReadSample(LeftAndRight);} 
  void WriteSampleSync(TSample LeftAndRight) { while (FSize==FBufSize) delay(1); WriteSample(LeftAndRight);}
};
