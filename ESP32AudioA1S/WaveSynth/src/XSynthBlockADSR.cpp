...
void TXSynthBlockADSR::Process(int samples) // New Construction: Implemented Full;
...
//                          Serial.println("Going To ADSRDECAY");
                          FDeltaTicks =0;
                        }
                      }
                      break; 
...
//                          Serial.println("Going To ADSRSUSTAIN");
                        }
                    }
									 break;
